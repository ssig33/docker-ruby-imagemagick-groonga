...
RUN wget http://packages.groonga.org/source/groonga/groonga-6.0.9.tar.gz && tar xvzf groonga-6.0.9.tar.gz && cd groonga-6.0.9 && ./configure && make -j9 && make install && cd .. && rm -rf groonga-6.0.9 groonga-6.0.9.tar.gz
