...
RUN wget http://cache.ruby-lang.org/pub/ruby/2.1/ruby-2.1.4.tar.bz2 && tar xvf ruby-2.1.4.tar.bz2 && cd  ruby-2.1.4 && ./configure && make -j4 && make install && cd .. && rm -rf  ruby-2.1.4 && rm -rf  ruby-2.1.4.tar.gz
