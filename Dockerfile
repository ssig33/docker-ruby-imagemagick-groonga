...
RUN wget http://packages.groonga.org/source/groonga/groonga-8.0.4.tar.gz && tar xvzf groonga-8.0.4.tar.gz && cd groonga-8.0.4 && ./configure && make -j9 && make install && cd .. && rm -rf groonga-8.0.4 groonga-8.0.4.tar.gz
